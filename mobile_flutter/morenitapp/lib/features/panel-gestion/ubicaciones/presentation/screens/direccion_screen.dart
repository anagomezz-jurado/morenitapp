            ...
            child: Column(
              ...
              children: [
                ...
                ref
                        ...
                        .whenData((list) => DropdownButtonFormField<int>(
                ...
                if (selProvId != null)
                  ref
                          ...
                          .whenData((list) => DropdownButtonFormField<int>(
                                ...
                                value: selLocId,
                                items: list
                                    .where((l) => l.codProvinciaId == selProvId)
                ...
                if (selLocId != null)
                  ref
                          ...
                          .whenData((list) => DropdownButtonFormField<int>(
                                ...
                                value: selCPId,
                                items: list
                                    .where((cp) => cp.localidadId == selLocId)
                                    .map((cp) => DropdownMenuItem(
                                        value: cp.id, child: Text(cp.name)))
                                    .toList(),
                                onChanged: (val) =>
                                    setState(() => selCPId = val),
                              ))
                          .value ??
                      const SizedBox(),
              ],
