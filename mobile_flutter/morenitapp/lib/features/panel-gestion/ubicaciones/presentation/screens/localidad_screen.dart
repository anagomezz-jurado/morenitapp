        ...
        data: (provincias) => SizedBox(
          ...
          child: DropdownButtonFormField<int>(
            ...
            decoration: const InputDecoration(
                labelText: 'Filtrar por Provincia', isDense: true),
            items: [
      ...
      rows: localidadesAsync.when(
        data: (lista) => lista
            .map((loc) => DataRow(cells: [
                  ...
                  DataCell(Text(
                      loc.codProvinciaId != null
                          ? provinciasAsync.value!
                              .firstWhere((p) => p.id == loc.codProvinciaId!)
                              .nombreProvincia
                          : '-',
                      style: const TextStyle(fontWeight: FontWeight.w500))),
                  ...
                  DataCell(Row(
                    children: [
                      IconButton(
                          ...
                          onPressed: () =>
                              _showSideForm(context, localidad: loc)),
                      IconButton(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            ...
            onPressed: () async {
              await ref
                  .read(localidadesProvider.notifier)
                  .borrarLocalidad(loc.id);
...
class _LocalidadFormContent extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_LocalidadFormContent> createState() =>
      _LocalidadFormContentState();
}
...
class _LocalidadFormContentState extends ConsumerState<_LocalidadFormContent> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: FilledButton(
                      ...
                      onPressed: _save,
                      child: Text(
                          widget.localidad == null ? "GUARDAR" : "ACTUALIZAR"),
                    ),
                  ),
                ],
              ),
  ...
  Widget _buildHeader(BuildContext context, ColorScheme colors, bool isNew) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(isNew ? Icons.add_location : Icons.edit_location,
              color: colors.primary),
          const SizedBox(width: 12),
          Text(isNew ? 'Nueva Localidad' : 'Editar Localidad',
              style: TextStyle(
                  fontSize: 20,
