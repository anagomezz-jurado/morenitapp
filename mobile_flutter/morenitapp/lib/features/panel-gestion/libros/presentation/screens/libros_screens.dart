  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return PlantillaVentanas(
      ...
      columns: const [
        ...
        DataColumn(label: Text('IMP. ANUNC.')),
        ...
        data: (libros) => libros
            .map((libro) => DataRow(
                  cells: [
                    ...
                    DataCell(Text(libro.nombre,
                        style: const TextStyle(fontWeight: FontWeight.bold))),
                    DataCell(Text(libro.anio.toString())),
                    DataCell(Text(
                      '${libro.totalAnunciantes.toStringAsFixed(2)} €',
                    ...
                    DataCell(Row(
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () =>
                              _confirmarEliminar(context, ref, libro),
                        ),
                      ],
                    )),
                  ],
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              final success =
                  await ref.read(librosProvider.notifier).borrarLibro(libro.id);
              if (ctx.mounted) {
                Navigator.pop(ctx);
                if (!success) {
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                      content: Text('Error al eliminar el libro')));
                }
              }
            },
